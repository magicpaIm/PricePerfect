...
import groupImage1 from "../src/assets/img/group1.png";
import groupImage2 from "../src/assets/img/group2.png";
...
export const heroData = {
  ...
  subtitle:
    "Tired of only being able to A/B test your product prices? Test up to 10 price points and once and efficiently find your optimal price and unlock your maximum revenue with PricePerfect.",
...
export const benifitData = {
  ...
  subtitle:
    "Not only does PricePerfect allow you to test core product prices, we also offer the opportunity to test price points on each of your variants. Simply select fixed or custom pricing for each variant and watch as PricePerfect tunes your pricing into perfection.",
  arrowtext: "Learn More",
...
export const TrustedmonialData = {
  ...
  subtitle:
    "Lorem ipsum dolor sit amet consectetur. Ligula lorem mi eget tellus id. Magna semper vulputate magna ut est felis. Proin faucibus nec ut duis orci aliquam id ipsum",
  arrowtext: "Learn More",
};
...
export const featuresData = {
  ...
  subtitle:
    "Lorem ipsum dolor sit amet consecteur. Fermentum hendrerit dictum pellentesque bibendum. Arcu at facilisi facilisis nisi diam. Nisl euismod aliquet mi id sed vel.",
};

export const footerData = {
  title: "Join thousands of shopify merchants and increase your revenue today.",
  subtitle:
    "Lorem ipsum dolor sit amet consecteur. Blandit tellus non feugiat ut eget maecenas. Dolor massa id vitae aliquam quam semper.",
...
export const testimonialData = [
  {
    titleup:
      "Recommend PricePerfect to improve pricing strategy for Shopify merchants. Our business saw significant",
  ...
  {
    titleup:
      "PricePerfect streamlined our pricing strategy, testing multiple price points per product without",
    titledown:
      " new links/ads. Saw a great increase in profits while saving the team time.",
    image: avatarImage1,
    name: "Ethan Davis",
    role: "",
  },
  ...
  {
    titleup:
      "PricePerfect is essential for e-commerce pricing optimization. Its user-friendly platform and data-driven ",
...
export const privacy = [
  "1. Introduction",
  `Welcome to PricePerfect, Inc.
    PricePerfect, Inc. (“us”, “we”, or “our”) operates www.priceperfect.io (hereinafter referred to as “Service”).
    Our Privacy Policy governs your visit to www.priceperfect.io, and explains how we collect, safeguard and disclose information that results from your use of our Service.
    We use your data to provide and improve Service. By using Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions.
    Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (“agreement”).`,

  `2. Definitions `,
  `SERVICE means the www.priceperfect.io website operated by PricePerfect, Inc. and use of any or of our apps, PricePerfect - Multivariate Price Testing. 
  ...
  `5. Use of Data `,
  `PricePerfect, Inc. uses the collected data for various purposes:
  ...
  `If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR. – See more at https://eur-lex.europa.eu/eli/reg/2016/679/oj
    ...
    If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at support@priceperfect.io.
  ...
  `CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy policy. The law’s reach stretches well beyond California to require a person or company in the United States (and conceivable the world) that operates websites collecting personally identifiable information from California consumers to post a conspicuous privacy policy on its website stating exactly the information being collected and those individuals with whom it is being shared, and to comply with this policy. – See more at: https://consumercal.org/about-cfc/cfc-education-foundation/california-online-privacy-protection-act-caloppa-3/
    ...
    (d)   users are able to change their personal information by emailing us at support@priceperfect.io.
  ...
  `If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:
    ...
    By email: support@priceperfect.io
    By visiting this page on our website: https://priceperfect.io/contact/
  ...
  `PricePerfect, Inc. uses remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimize and serve ads based on your past visits to our Service.
    Google Ads (AdWords)
