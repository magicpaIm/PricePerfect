...
const Footer = () => {
    ...
    return (
        <div className='flex flex-col bg-slate-900 lg:py-10 w-full rounded-3xl'>
            <div className='flex flex-col px-2 lg:px-10'>
                ...
                <div className='flex flex-col lg:flex-row py-10'>
                    ...
                    <iframe className="float-right w-[380px] lg:w-[1200px] h-[240px] lg:h-[420px] z-0"
                        src="https://www.youtube.com/embed/v-GhY-Y1OyA" alt="footer" data-aos="zoom-in" data-aos-delay='300'
