...
const Trustedmonial = () => {
    ...
    return (
        <div className='bg-slate-900 flex flex-col py-10 w-full'>
            <div className='flex flex-row gap-5 px-10' data-aos='fade-up' data-aos-offset='300'>
                <div className='w-1/2 p-10'>
                    <p className='description' data-aos="fade-up" data-aos-delay='200'>{order}</p>
                    <h1 className='title text-5xl text-white pr-10 ' data-aos="fade-up" data-aos-delay='300'>{title}</h1>
                </div>
                <div className='w-1/2 p-10'>
                    <p className='subtitle pr-10 pt-10' data-aos="fade-up" data-aos-delay='400'>{subtitle}</p>
