    ...
    <div className="px-5 w-full">
      <div className="container1" data-aos="fade-up" data-aos-delay="200">
        <div className="w-full text-center justify-center items-center ">
          ...
          <div
            className="flex flex-col heroBg mx-auto w-[300px] h-[200px] lg:h-[500px] lg:w-[1100px] bg-center bg-no-repeat bg-cover"
            data-aos="fade-up"
            data-aos-delay="900"
          >
            <img
              src={image1}
              className="mt-8 lg:mt-1 w-[100px] h-[50px] lg:h-[170px] lg:w-[380px]"
              data-aos="zoom-in-left"
              data-aos-delay="800"
            />
            <img
              src={image2}
              className="mb-10 lg:mb-5 w-[150px] h-[100px] lg:h-[400px] lg:w-[500px] ml-auto pl-5 lg:pl-8 "
